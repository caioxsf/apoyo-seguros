...
export default function Services() {
    return (
        <div className="flex flex-col items-center justify-center min-h-screen bg-gradient-to-br bg-[#003366] px-4 py-16">
            {/* Header */}
            ...
            {/* Card Principal */}
            <div className="bg-white rounded-2xl shadow-2xl p-8 lg:p-12 max-w-4xl w-full">
                {/* Ícone e Título */}
                ...
                <Link
                    ...
                    className="flex items-center justify-center mt-10 gap-2 text-blue-950 font-semibold  bg-blue-100 hover:bg-blue-950 hover:text-[#ffee00e1] 
